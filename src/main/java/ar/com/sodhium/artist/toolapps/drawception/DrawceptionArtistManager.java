...
public class DrawceptionArtistManager {
    ...
    private void doFindCircles(ColorMap input) throws Exception {
        ...
        ColorMap intThresholdInColors = ThresholdUtils.intThresholdInColors(absoulteMagnitude, absoulteMagnitude,
                absoulteMagnitude, width, height, 225 * 225 * 225);
        ...
        ComposedRectangularZone rectanglesSet = ImageClusteringUtils.findRectanglesWithBlackContent(blackRed,
                blackGreen, blackBlue, width, height);
